...
namespace Mispollos.Persistence.Migrations
{
    ...
    [Migration("20210607031133_fecha-de-vencimiento-cambiada-a-tipo-date")]
    partial class fechadevencimientocambiadaatipodate
    {
            ...
            modelBuilder.Entity("Mispollos.Entities.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cf5c5957-00cf-48e5-b631-4c32e834171d"),
                            Nombre = "Admin"
                        },
                        new
                        {
                            Id = new Guid("5b1e7c93-1d53-48ea-84da-e598125abbfa"),
                            Nombre = "Usuario"
                        });
                });
